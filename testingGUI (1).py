...
register=tk.Button(text="Register", height="2", width="10",command=ob1.user, font=("bold",22), bg='blue')
register.pack(ipadx=15, ipady=15)
register.pack(padx=80, pady=30)

login=tk.Button(text="Login", height="2", width="10",command=ob1.userlogin,font=("bold",22), bg='blue')
